...
from torch_timeseries.nn.Autoformer_EncDec import series_decomp
    ...
    def __init__(
        ...
        if self.task_name == 'classification':
            if num_class is None:
                raise ValueError("num_class must be provided for classification task")
            self.act = F.gelu
            self.dropout = nn.Dropout(dropout)
...
# Backward-compatibility: older code may import/use `Model(configs)`.
class Model(TimeMixer):
    def __init__(self, configs):
        super().__init__(
            ...
            down_sampling_method=configs.down_sampling_method,
            ...
            d_ff=configs.d_ff,
            num_class=getattr(configs, "num_class", None),
        )