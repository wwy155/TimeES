...
class WaveFormer(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        waves = (x_token - means.unsqueeze(2).detach()) / (stds.unsqueeze(2).detach() + 1e-8) # B, K, wave_len, N
        ...
        tp_token = time_prior.view(B, self.output_token_num, self.wave_len, N).permute(0, 3, 1, 2)
        
        dec_out = self.wave_embedding(tp_token) # B*N, oK, D
