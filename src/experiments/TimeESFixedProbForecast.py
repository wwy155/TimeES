...
@dataclass
class TimeESProbForecast(ProbForecastExp, Parameters):
    model_type: str = "TimeESFixedAProbForecast"
    ...
    def _test(self):
        self.plot()
        return super(TimeESProbForecast, self)._test()
